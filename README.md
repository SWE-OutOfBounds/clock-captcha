...
| inject(container : HTMLElement)        | Place the module into a HTML container               | void   | `captchaModule.inject(document.getElementById('clock-captcha'))` |
...
var clockWithNoiseAndShapeStrategy = new cc.NoiseDecorator(
  clockWithShapeStrategy,
  10
);
var clockWithShapeAndNoiseStrategy = new cc.ShapeDecorator(
  clockWithShapeStrategy,
  7
);
